...
def generateOutlineIcon(img, active = False, size = (29,29), color = ""):
    '''Generates an icon image given an image, active section, image size (no outline), and an optional overriding outline color, with the image having a border outline.'''
